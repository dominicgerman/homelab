...
This is where I try to keep up-to-date documentation for my homelab. I'm frequently tearing down and rebuilding things and it's nice to have a record of how I usually set things up. Otherwise I wind up searching my ChatGPT or web browser history every time I need to find something.
